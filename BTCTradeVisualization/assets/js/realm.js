...
if($('#dashboard_page').length > 0 ){
  ...
  $.gritter.add({
    ...
    title: 'Welcome the BTC Predictor',
    // (string | mandatory) the text inside the notification
    text: 'This site uses the Alina API, which utilizes machine learning and genetic algorithms to determine future prices of bitcoin',
    // (string | optional) the image to display on the left
    image: 'http://2.bp.blogspot.com/_rq_zL3HbUNs/TFiHNm2dqmI/AAAAAAAAAK4/XTm2pBjqw_o/s1600/1927,+False+Maria+%28Metropolis%29,+Fritz+Lang.jpg',
